    ...
    <aside class="w-64 bg-purple-900 text-white min-h-screen p-6 flex flex-col justify-between">
        <div>
            ...
            <nav class="space-y-4 text-sm font-medium opacity-80">
                ...
                <a href="#" class="block text-white opacity-100 font-bold bg-purple-800 -mx-6 px-6 py-2 border-l-4 border-l-orange-400">Veículos</a>
                ...
                <div>
                    ...
                    <form class="space-y-3">
                        <div>
                            ...
                            <input type="text" value="Ônibus Trucado 125" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-[10px] uppercase font-bold text-gray-400">Placa:</label>
                                <input type="text" value="IVS-2622" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5 font-mono">
                            </div>
                            <div>
                                <label class="block text-[10px] uppercase font-bold text-gray-400">Modelo:</label>
                                <input type="text" value="Marcopolo" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                <label class="block text-[10px] uppercase font-bold text-gray-400">Chassi:</label>
                                <input type="text" value="Scania" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                            </div>
                            <div>
                                <label class="block text-[10px] uppercase font-bold text-gray-400">Capacidade:</label>
                                <input type="number" value="45" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                            </div>
                        </div>
                        <div>
                            <label class="block text-[10px] uppercase font-bold text-gray-400">Tipo de ônibus:</label>
                            <input type="text" value="Ônibus Rodoviário" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                        </div>
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" value="2006" class="w-full border border-gray-200 rounded px-2 py-1.5 text-xs mt-0.5">
                            </div>
                        </div>
                        ...
                        <div class="pt-3">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-[11px]">
                                <button type="button" class="border border-purple-800 text-purple-900 rounded p-1.5 flex items-center justify-center space-x-1 font-medium bg-purple-50"><span>Internet</span></button>
                                <button type="button" class="border border-purple-800 text-purple-900 rounded p-1.5 flex items-center justify-center space-x-1 font-medium bg-purple-50"><span>WC</span></button>
                                <button type="button" class="border border-gray-200 text-gray-500 rounded p-1.5 flex items-center justify-center space-x-1 hover:border-purple-300"><span>Tomada</span></button>
                                <button type="button" class="border border-purple-800 text-purple-900 rounded p-1.5 flex items-center justify-center space-x-1 font-medium bg-purple-50"><span>Ar Condicionado</span></button>
                                <button type="button" class="border border-purple-800 text-purple-900 rounded p-1.5 flex items-center justify-center space-x-1 font-medium bg-purple-50"><span>Geladeira</span></button>
                                <button type="button" class="border border-gray-200 text-gray-500 rounded p-1.5 flex items-center justify-center space-x-1 hover:border-purple-300"><span>Calefação</span></button>
                                <button type="button" class="border border-purple-800 text-purple-900 rounded p-1.5 col-span-2 flex items-center justify-center space-x-1 font-medium bg-purple-50"><span>Vídeo</span></button>
                            </div>
                        </div>
                    </form>
                </div>
